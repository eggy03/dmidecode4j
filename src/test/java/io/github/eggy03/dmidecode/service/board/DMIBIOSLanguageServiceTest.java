...
class DMIBIOSLanguageServiceTest {
    ...
    private final DMIBIOSLanguage mockDMIClass = new ImmutableDMIBIOSLanguage.Builder()
    ...
    @Mock
    private DMIBIOSLanguageMapper mapper;
    @InjectMocks
    private DMIBIOSLanguageService service;
    ...
    void test_get_returnsMappedResult() {
        ...
        Optional<DMIBIOSLanguage> result = service.get(15);
        ...
        inOrder.verify(terminalService).executeCommand(DMIType.BIOS_LANGUAGE, 15);
        inOrder.verify(mapper).mapToEntity(validTerminalResult.getResult(), DMIBIOSLanguage.class);
    ...
    void test_get_returnsEmptyWhenMapperReturnsEmpty() {
        ...
        Optional<DMIBIOSLanguage> result = service.get(10);
        assertThat(result).isEmpty();

        InOrder inOrder = inOrder(terminalService, mapper);
        inOrder.verify(terminalService).executeCommand(DMIType.BIOS_LANGUAGE, 10);
        inOrder.verify(mapper).mapToEntity(validTerminalResult.getResult(), DMIBIOSLanguage.class);
